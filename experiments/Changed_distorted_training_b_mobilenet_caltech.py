...
# File made ready for training.
# Use already trained pristine branch from the trained Mixed_Dist
...
model_save_path = os.path.join(
    results_dir,
    f"Original_{distortion_type}_model_{model_name}_{dataset_name}_{model_id}.pth"
)
...
pristine_model_path = os.path.join(
    results_dir,
    f"Original_pristine_model_{model_name}_{dataset_name}_{model_id}.pth"
)
df_history_save_path = os.path.join(
    results_dir,
    f"Original_history_distorted_{distortion_type}_{model_name}_{dataset_name}_{model_id}.csv"
)
