...
from Mix_Dist_distortionNet import DistortionNet
import argparse
...
if __name__ == "__main__":
  ...
  plt.legend()
  plt.grid(True)
  plt.savefig(os.path.join("experiments", "4_Mix_Dist_distortion_classifier_accuracy_plot.png"), 
              bbox_inches="tight")
  # The loss plot
  plt.figure()
  ...
  plt.legend()
  plt.grid(True)
  plt.savefig(os.path.join("experiments", "5_Mix_Dist_distortion_classifier_loss_plot.png"), 
              bbox_inches="tight")
  plt.close()
